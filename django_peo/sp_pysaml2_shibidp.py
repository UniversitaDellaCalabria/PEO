...
BASE_URL = 'https://peo.unical.it/saml2'
IDP_URL = 'https://idp.unical.it/idp'
...
SAML_CONFIG = {
    ...
    # 'ca_certs' : os.path.join(BASE_DIR, 'saml2_config/certificates', "testunical.it-cacert.pem"),
    ...
    # Signing
    'key_file': BASE_DIR + '/saml2_sp/saml2_config/certificates/sp-key.pem',
    'cert_file': BASE_DIR + '/saml2_sp/saml2_config/certificates/sp-cert.pem',
